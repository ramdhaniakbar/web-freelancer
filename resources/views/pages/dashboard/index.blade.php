               ...
               <div class="sm:grid sm:h-32 sm:grid-flow-row sm:gap-4 sm:grid-cols-3">
                  <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                     <div>
                        ...
                        <p class="text-sm text-left text-gray-500"> Services <br class="hidden lg:block"> On Progress </p>
                     </div>
                  </div>
                  <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                     <div>
                        ...
                        <p class="text-sm text-left text-gray-500"> Services <br class="hidden lg:block"> Completed </p>
                     </div>
                  </div>
                  <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                     <div>
                        ...
                        <p class="text-sm text-left text-gray-500"> New Freelancer <br class="hidden lg:block"> Work for You </p>
                     </div>
                  </div>
               </div>
                                 ...
                                 <div class="flex items-center text-sm">
                                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                       ...
                                       @if ($item->user_buyer->detail_user->photo != null)
                                          <img src="{{ url(Storage::url($item->user_buyer->detail_user->photo)) }}" alt="photo profile" class="object-cover inline w-12 h-12 mr-3 rounded-full">
                                       @else
