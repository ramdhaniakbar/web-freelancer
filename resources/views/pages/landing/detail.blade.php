            ...
            <div class="px-4 pb-4 booking">
               @auth
                  <a href="{{ route('booking.landing', $service->id) }}"
                     class="block px-12 py-4 my-2 text-lg font-semibold text-center text-white bg-serv-button rounded-xl" onclick="return confirm('Are you sure want to book this service?')">
                     Booking Now
                  </a>
               @endauth
               @guest
